...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Dog.birthDate":
		if e.complexity.Dog.BirthDate == nil {
			break
		}

		return e.complexity.Dog.BirthDate(childComplexity), true
	...
	case "Dog.owner":
		if e.complexity.Dog.Owner == nil {
			break
		}

		return e.complexity.Dog.Owner(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `enum Breed {
  CHIHUAHUA
}
...
func (ec *executionContext) _Dog_breed(ctx context.Context, field graphql.CollectedField, obj *model.Dog) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBreed2binᚋborkᚋgraphᚋmodelᚐBreed(ctx, field.Selections, res)
}

func (ec *executionContext) _Dog_birthDate(ctx context.Context, field graphql.CollectedField, obj *model.Dog) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Dog_owner(ctx context.Context, field graphql.CollectedField, obj *model.Dog) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputDogInput(ctx context.Context, obj interface{}) (model.DogInput, error) {
	...
	for k, v := range asMap {
		...
		case "breed":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("breed"))
			it.Breed, err = ec.unmarshalNBreed2binᚋborkᚋgraphᚋmodelᚐBreed(ctx, v)
			if err != nil {
				return it, err
			}
		case "name":
...
func (ec *executionContext) _Dog(ctx context.Context, sel ast.SelectionSet, obj *model.Dog) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "birthDate":
			out.Values[i] = ec._Dog_birthDate(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "owner":
			out.Values[i] = ec._Dog_owner(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNBreed2binᚋborkᚋgraphᚋmodelᚐBreed(ctx context.Context, v interface{}) (model.Breed, error) {
	var res model.Breed
	err := res.UnmarshalGQL(v)
	return res, graphql.WrapErrorWithInputPath(ctx, err)
}

func (ec *executionContext) marshalNBreed2binᚋborkᚋgraphᚋmodelᚐBreed(ctx context.Context, sel ast.SelectionSet, v model.Breed) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNDog2binᚋborkᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚕᚖbinᚋborkᚋgraphᚋmodelᚐDogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Dog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDog2ᚖbinᚋborkᚋgraphᚋmodelᚐDog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDog2ᚖbinᚋborkᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
